...
export class FroalaIntegration extends IntegrationModel {
  ...
  simulateClick(element) {
    const dispatchMouseEvent = function (target) {
      ...
      e.initEvent.apply(e, Array.prototype.slice.call(arguments, 1)); // eslint-disable-line prefer-rest-params, prefer-spread
...
(function ($) {
  ...
  function createIntegrationModel(editor) {
    ...
    froalaIntegrationProperties.serviceProviderProperties.URI = 'integration';
    froalaIntegrationProperties.serviceProviderProperties.server = 'php';
